...
[Software Carpentry Git](http://swcarpentry.github.io/git-novice/02-setup.html)
...
To test your setup on the JupyterHub, we will be using a test repository. Paste the following command into your open
terminal on the JupyterHub. where you will be prompted for your GitHub username
and the token.

```shell
git clone https://github.com/mgrover1/check_github_setup
```
